...
def objective(trial:optuna.trial.Trial):
    ...
    #cross validation
    score_split = cross.cross_validation(trial=trial,drop=drop,threshold=threshold,percentage=percentage,dimension=dimension,time_delay=time_delay,optimizer_name=optimizer_name,lr=lr,batch_size=batch_size,epochs=epochs,weight_decay=weight_decay,embedding_dim=embedding_dim,n_FPT=n_FPT,n_period=n_period)
