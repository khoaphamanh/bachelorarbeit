...
class CrossValidation:
    ...
    def load_scaler (self,split, test_raw_data:TensorDataset, b, fc, scale_min, scale_max, n_scales, clamp = False):
        ...
        #transform to image
        test_data = self.transformation.cwt(test_data, b = b, fc = fc, scale_min=scale_min, scale_max=scale_max, n_scales=n_scales)   
    ...
    def final_test (self,best_params:dict,best_trial_number):
        ...
        train_data, full_data, _ = self.transform_image(train_raw_data=train_data,test_raw_data=full_data,b = b, fc = fc, scale_min=scale_min, scale_max=scale_max,n_scales=n_scales) 
