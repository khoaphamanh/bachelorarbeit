...
class CrossValidation:
    ...
    def load_scaler (self,split, test_raw_data:TensorDataset, n_bins, strategy, clamp = False):
        ...
        #transform to image
        test_data = self.transformation.mtf(test_data, n_bins=n_bins, strategy=strategy)    
    ...
    def final_test (self,best_params:dict,best_trial_number, evaluate = False):
        ...
        train_data, full_data, _ = self.transform_image(train_raw_data=train_data,test_raw_data=full_data,n_bins=n_bins, strategy=strategy)
