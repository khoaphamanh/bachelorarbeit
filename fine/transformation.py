...
class Transformation:
    ...
    def load_model (self,drop,device):
        ...
        model_1 = Wavegram_Logmel_Cnn14(sample_rate=self.sr,window_size=1024,hop_size=320,mel_bins=64,fmin=0,fmax=self.sr//2,classes_num=527)
        model_1.load_state_dict(state_dict,strict=False)
        model_2 = Wavegram_Logmel_Cnn14(sample_rate=self.sr,window_size=1024,hop_size=320,mel_bins=64,fmin=0,fmax=self.sr//2,classes_num=527)
