...
def objective(trial:optuna.trial.Trial):
    ...
    #cross validation
    loss_val = cross.cross_validation(trial=trial,drop=drop,n_bins=n_bins,strategy=strategy,optimizer_name=optimizer_name,lr=lr,batch_size=batch_size,epochs=epochs,weight_decay=weight_decay,embedding_dim=embedding_dim,n_FPT=n_FPT,n_period=n_period)
