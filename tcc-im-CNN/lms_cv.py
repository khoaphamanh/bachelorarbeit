...
def objective(trial:optuna.trial.Trial):
    ...
    #cross validation
    loss_val = cross.cross_validation(trial=trial,drop=drop,w_stft=w_stft,hop=hop,optimizer_name=optimizer_name,lr=lr,batch_size=batch_size,epochs=epochs,weight_decay=weight_decay,embedding_dim=embedding_dim,n_FPT=n_FPT,n_period=n_period,n_mels = n_mels)
